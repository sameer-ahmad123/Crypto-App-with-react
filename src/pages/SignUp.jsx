    ...
    <div className='w-screen h-screen flex justify-center items-center'>
      <div className="box w-80 lg:w-96 h-auto shadow-[0_0_15px_rgba(0,0,0,0.1)] rounded-2xl p-6  m-auto">
        ...
        <form action={""} onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className='repeatpassword mt-4.5'><p className='text-sm font-semibold'>Repeat Password</p><input {...register("password",{required:true,minLength: {value : 3,message : "Min length is 8"}})}  className='border py-0.5 px-1.5 lg:w-full w-80% border-gray-300  rounded-lg' type="text" />
          {errors.password && <div className='text-red-500 text-sm'>Please Enter password again</div>}</div>
          <div className=' mt-4 '>
            <div className='flex'>
