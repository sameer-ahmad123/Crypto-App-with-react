    ...
    <div className='w-screen h-screen flex justify-center items-center'>
      ...
      <div  className="card h-72 w-96  shadow-[0_0_15px_rgba(0,0,0,0.1)] rounded-2xl p-6">
         <div className=' w-full  '>
            ...
            <div className='email mt-4.5'><p className='text-sm font-semibold'>Email</p><input {...register("email",{required:true})} placeholder='name@gmail.com' className='border py-0.5 px-1.5 w-full  border-gray-300  rounded-lg' type="text" />
